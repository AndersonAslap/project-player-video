...
export function Player() {
  return (
    <div 
      ...
      <div 
        className="flex w-[1100px] flex-col gap-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex flex-col gap-1">
              ...
              <span className="text-sm text-zinc-400">Módulo "Desvandando o Redux"</span>
            </div>
              ...
              <aside className="w-80 border-l border-zinc-800 bg-zinc-900">
                <div>
                  <button className="flex w-full items-center gap-3 bg-zinc-800 p-4">
                    ...
                    <ChevronDown className="m-5 h-5 ml-auto text-zinc-400" />
                  </button>
                  ...
                  <nav className="relative flex flex-col gap-4 p-6">
                    <button className="flex items-center gap-3 text-sm text-zinc-400">
                      ...
                      <span className="ml-auto font-mono text-sm text-zinc-500">12:00</span>
                    </button>
